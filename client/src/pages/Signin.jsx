                ...
                <form onSubmit={handleLogin} className="space-y-6 mt-6">
                    <div>
                        ...
                        <input
                            ...
                            value={formData.email}
                            onChange={handleChange}
                            className="w-[300px] text-[14px] h-[40px] bg-[#2a2a2a] text-white border border-gray-700 rounded-lg px-4 focus:ring-2 focus:ring-purple-500 outline-none"
                            placeholder="you@example.com"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                value={formData.password}
                                onChange={handleChange}
                                className="w-[300px] text-[14px] h-[40px] bg-[#2a2a2a] text-white border border-gray-700 rounded-lg px-4 pr-12 focus:ring-2 focus:ring-purple-500 outline-none"
                                placeholder="Enter your password"
                                required
                            />
                            <button
