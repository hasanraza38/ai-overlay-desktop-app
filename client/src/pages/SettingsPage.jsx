...
export default function SettingsPage() {
    ...
    const handleReset = async () => {
        try {
            ...
            // Electron storage reset karo agar available hai
            if (window.electronAPI) {
                ...
                <div className="bg-white/5 backdrop-blur-xl rounded-xl mt-7 p-4 mb-4 border border-white/10 flex items-center justify-between">
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                className="bg-gradient-to-b ml-1.5 dark:from-white dark:to-white/50 from-neutral-950 to-neutral-950/50 bg-clip-text text-xs text-transparent group-hover:scale-105 transition transform-gpu"
                            >
                                Upgrade your Plan
                            </span>
                        </span>
