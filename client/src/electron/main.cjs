...
//     try {
//       // Save token in keytar (secure storage)
//       await keytar.setPassword(KEYTAR_SERVICE, KEYTAR_ACCOUNT, token);
//       console.log("Token saved in keytar");

//       // Set token as cookie in session
//       const cookie = {
//         url: "http://localhost:3000", // Aapka React app URL (adjust if needed)
//         name: "auth_token",
//         value: token,
//         httpOnly: true, // JavaScript se access nahi ho sakega
//         secure: false, // Localhost ke liye false; production mein true (HTTPS)
//         sameSite: "strict", // CSRF protection
//         expirationDate: Math.floor(Date.now() / 1000) + 60 * 60 * 24 * 7, // 7 days expiry
//       };
